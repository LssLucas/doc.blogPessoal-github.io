                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-8fc0ae73394e3002f9a637d3a05f000f"' : 'data-target="#xs-components-links-module-AppModule-8fc0ae73394e3002f9a637d3a05f000f"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-8fc0ae73394e3002f9a637d3a05f000f"' :
                                            'id="xs-components-links-module-AppModule-8fc0ae73394e3002f9a637d3a05f000f"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/ServiceauthService.html" data-type="entity-link">ServiceauthService</a>
                                </li>
                                <li class="link">
